...
```
lab2/
├── lab2/                  # Основное приложение
│   ├── Models/           # Модели данных (выражения, предикаты, операторы)
│   ├── ViewModels/       # Логика представления
│   ├── Views/           # Пользовательский интерфейс
│   └── Coverters.cs     # Вспомогательные конвертеры
...
При обнаружении ошибок или предложениях по улучшению создавайте issue в репозитории проекта или обращайтесь к разработчикам.

Программа создана в образовательных целях для изучения формальных методов верификации программ.
